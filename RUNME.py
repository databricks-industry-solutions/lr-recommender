...
# MAGIC
# MAGIC client.execute_post_json(f"{client.endpoint}/api/2.0/secrets/put", {
# MAGIC   "scope": "recommender-readwrite",
# MAGIC   "key": "onlinefs-authorization-key",
# MAGIC   "string_value": "____"
# MAGIC })
# MAGIC
# MAGIC client.execute_post_json(f"{client.endpoint}/api/2.0/secrets/put", {
# MAGIC   "scope": "recommender-readonly",
# MAGIC   "key": "onlinefs-authorization-key",
# MAGIC   "string_value": "____"
# MAGIC })
# MAGIC ```
...
job_json = {
        ...
        "tasks": [
            ...
            },
            {
                "job_cluster_key": "lr_rec_cluster",
                "notebook_task": {
                    "notebook_path": f"02_Generate_Features"
                },
                "task_key": "lr_rec_02",
                "depends_on": [
                    {
            ...
            },
            {
                "job_cluster_key": "lr_rec_cluster",
                "notebook_task": {
                    "notebook_path": f"03_Train_Model"
                },
                "task_key": "lr_rec_03",
                "depends_on": [
                    {
