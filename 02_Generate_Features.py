...
# MAGIC %md The purpose of this notebook is to prepare the features for use in the classifier recommender.  This notebook was developed on a **Databricks ML 12.2** cluster.
